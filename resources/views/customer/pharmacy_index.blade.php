        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-6">
                            <h5 class="card-title">Pharmacy  Customer </h5>
                        </div>
                        <div class="col-lg-6 text-right">
                            ...
                            @can('pharmacy_customers.create')
                                <a  href="{{route('pharmacy_customers.create')}}" class="btn btn-info btn-sm">+ Add New Customer</a>
                            @endcan
                        </div>
                        ...
                        @foreach ($customers as $key =>  $customer)
                            ...
                            <tr>
                                ...
                                <td style="width: 100px;">
                                    @can('pharmacy_customers.edit')
                                        <a href="{{ route('pharmacy_customers.edit',$customer['id'])}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                    @endcan
