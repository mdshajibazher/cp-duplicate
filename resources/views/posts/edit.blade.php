    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <input type="text" id="title" placeholder="Enter Title" class="form-control @error('title') is-invalid @enderror" name="title" value="{{old('title',$post->title)}}" required>
                ...
                <input type="file" id="image" placeholder="Upload Post Image" class="form-control @error('image') is-invalid @enderror" name="image" >
                ...
                <div class="form-group">
                    <img src="{{asset('uploads/posts/single/cropped/'.$post->image)}}" alt="">
                </div>
