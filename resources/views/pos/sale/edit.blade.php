...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="p_wrapper">
                <div class="row">
                    <div class="col-lg-4"><a href="{{route('sale.index')}}" class="btn btn-sm btn-warning"><i
                        ...
                        <div class="form-group">
                            ...
                            <select  class="form-control" name="warehouse_id" id="warehouse_id" class="form-control">
                                @foreach ($warehouses as $warehouse)
                                    <option value="{{$warehouse->id}}" @if($sale->warehouse_id == $warehouse->id) selected @elseif($g_opt_value['warehouse_id'] != $warehouse->id) disabled @endif >{{$warehouse->name}}</option>
                                @endforeach
                            </select>
                        </div>
