    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-4">
                        <h5 class="card-title">Return Invoice</h5>
                    </div>
                    <div class="col-lg-8">
                        @can('return_invoice.create')
                        ...
                        <table class="table" id="jq_datatables">
                          ...
                          <tbody>
                              ...
                              @if($item->deleted_at == NULL)
                                <td ><a target="_blank" class="btn btn-info btn-sm" href="{{route('returnproduct.show',$item->id)}}"><i class="fa fa-eye"></i></a>             @can('return_invoice.edit')| <a target="_blank" class="btn btn-primary btn-sm" href="{{route('returnproduct.edit',$item->id)}}"><i class="fa fa-edit"></i></a> @endcan
                                </td>
                              @else
