...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="p_wrapper">
                <div class="row">
                    <div class="col-lg-4"><a href="{{route('returnproduct.index')}}" class="btn btn-sm btn-dark"><i
                                class="fa fa-angle-left"></i> back</a></div>
                    <div class="col-lg-8">
                        <strong class="float-right">EDIT RETURN INVOICE # {{$return->id}}</strong>
                    </div>
                </div>
                <hr>
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label for="return_date">Date
                                <button onclick="changeDate()" class="btn btn-link">(change)</button>
                            </label>
                            @php
                        ...
                        <div class="form-group">
                            ...
                            <select data-placeholder="-select user-" class="js-example-responsive" name="user" id="user"
                                    class="form-control">
                                <option></option>
                            ...
                            <select class="form-control" name="warehouse_id" id="warehouse_id" class="form-control">
                                @foreach ($warehouses as $warehouse)
                                    <option value="{{$warehouse->id}}"
                                            @if($return->warehouse_id == $warehouse->id) selected
                                            @elseif($g_opt_value['warehouse_id'] != $warehouse->id) disabled @endif >{{$warehouse->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div style="margin-top: 31px">
                            <button type="button" class="btn btn-dark  add-to-cart">ADD <i class="fa fa-plus"></i>
                            </button>
                        </div>
            ...
            <div class="p_detail_wrapper table-responsive">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5" id="amount-info">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>Carrying & Loading <input type="number" class="form-control tiny-input"
                                                              ...
                                                              value="{{$return->carrying_and_loading}}"></td>
                        ...
                        <button type="button" class="btn btn-dark" id="confirm-btn" onclick="confirm_return()">Confirm
                        </button>
