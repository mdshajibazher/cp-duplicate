	...
	<div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <h5 class="text-right">Assign Customers</h5>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
          <form action="{{route('assigncustomers.store')}}" method="POST">
              @csrf
              <div class="form-group">
                <label for="from">From</label>
                <input type="text" class="form-control @error('from') is-invalid @enderror" name="from" id="from" placeholder="Select  Date" value="{{old('from')}}">
                    @error('from')
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('to') is-invalid @enderror" name="to" id="to" placeholder="Select  Date" value="{{old('to')}}">
                    @error('to')
                    <small class="form-error">{{ $message }}</small>
                    @enderror
              </div>
